<template>
  <div class="nextReleasesContainer">
    <div class="videoContainer">
      <video autoplay loop src="../assets/video2.mp4"></video>
    </div>

    <div class="containerReleases">
      <h1>Let's deploy to production</h1>
      <p>
        Anthony Sanders wants us to deploy it to the Production.
        While It's been second week of the Machine learning class.
      </p>
      <button id="buttonPlay">
        <v-icon name="play" scale="1" id="iconMain1" color="#e5e5e5" />
        <span>Watch</span>
      </button>
